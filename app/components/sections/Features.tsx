...
const features = [
  {
    ...
    description: "Guide users through your product with step-by-step interactive walkthroughs.",
  },
  {
    icon: FiCode,
    title: "Easy Integration",
    description: "Add a single script tag to any website. Works with React, Vue, or vanilla JS.",
  },
  {
  ...
  },
  {
    ...
    description: "Minimal bundle size ensures your page speed stays unaffected.",
  },
  {
    icon: HiOutlineSparkles,
    title: "Smart Targeting",
    description: "Show tours to the right users at the right time with targeting rules.",
  },
];

return (
     <section id="features" className="py-24 bg-card/50 bg-[#0A0F17] text-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Powerful features to create engaging onboarding experiences that convert.
            </p>
          </motion.div>
