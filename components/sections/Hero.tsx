                ...
                <div className="container mx-auto relative z-10 text-white my-10 mt-20 px-5 md:px-0 ">
                    ...
                    >
                        ...
                        <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
                            Create interactive onboarding experiences that guide
                            your users and boost engagement. No coding required.
                        </p>
                        ...
                        <div className="max-w-xl md:max-w-3xl mx-auto bg-[#0A101D]/80 border border-border rounded-2xl shadow-2xl overflow-hidden">
                            ...
                            <div className="p-8 bg-[#0A101D]/80 min-h-[300px] flex items-center justify-center">
                                <div className="text-center">
                                    <div
                                        className="w-16 h-16 rounded-2xl bg-[#800080] flex items-center
